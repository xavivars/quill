...
class History extends module_1.default {
    constructor(quill, options) {
        ...
        this.clear();
        this.quill.on(quill_1.default.events.EDITOR_CHANGE, (eventName, delta, oldDelta, source) => {
            if (eventName !== quill_1.default.events.TEXT_CHANGE || this.ignoreChange)
                return;
            if (!this.options.userOnly || source === quill_1.default.sources.USER) {
...
function endsWithNewlineChange(scroll, delta) {
    ...
    if (lastOp.attributes != null) {
        return Object.keys(lastOp.attributes).some(attr => {
            return scroll.query(attr, parchment_1.Scope.BLOCK) != null;
        });
    }
    return false;
}
