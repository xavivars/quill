...
declare type Binding = BindingObject | string | number;
...
declare class Keyboard extends Module<KeyboardOptions> {
    static match(evt: KeyboardEvent, binding: any): boolean;
...
declare function normalize(binding: Binding): BindingObject;
